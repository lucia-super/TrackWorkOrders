...
const _setHeaders = (defaultHeaders, req) => {
  // REVISIT: If headers of root match custom headers, no custom headers were provided.
  // Ignore them for the request to the remote service.
  // Can be deleted once the inheritance of _.req is cleaned up.
  if (req.context && req.context.headers === req.headers) {
