...
# EXPLANATION
    ...
    the current environment in JavaScript object format. <ls | list> displays
    it in _.properties_ format.

    The other variants either get or set a single option or display the sources
    from which the effective configuration has been loaded.
...
const commands = {
  ...
  get (conf, key, val) {
    ...
    console.log (inspect (obj, {depth:22,colors:true}))
  },
