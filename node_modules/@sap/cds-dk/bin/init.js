...
module.exports = Object.assign(init, {
    options: ['--add', '--java:mvn', '--java:package', ...legacyOptions],
    shortcuts: [],
    flags: ['--force', '--verbose'],
    help: `
# SYNOPSIS
...
# OPTIONS
    ...
    *--add* <feature | comma-separated list of features>
        ...
        *mta*         - adds an _mta.yaml_ file for MTA based SAP Cloud Platform deployment
    ...
    *--java:mvn* <Comma separated maven archetype specific parameters>
        ...
        Add the given paramters to the archetype call.
